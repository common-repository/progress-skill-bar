...
.pbar-6310-template-".esc_attr($ids)."-bar{ 
  box-shadow: none;
  border-bottom: ".esc_attr($cssData['pbar_progress_bar_border_size'])."px dotted;
  position: relative;
  -webkit-animation: animate-positive-12 ".esc_attr($cssData['animation_duration'])."s;
  animation: animate-positive-12 ".esc_attr($cssData['animation_duration'])."s;
}
...
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+1) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color: ".esc_attr($cssData['pbar_progress_bar_background_first_color']).";
}
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+2) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color: ".esc_attr($cssData['pbar_progress_bar_background_second_color']).";
}
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+3) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color:".esc_attr($cssData['pbar_progress_bar_background_third_color']).";
}
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+4) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color: ".esc_attr($cssData['pbar_progress_bar_background_forth_color']).";
}
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+5) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color: ".esc_attr($cssData['pbar_progress_bar_background_fifth_color']).";
}
.pbar-6310-row .pbar-6310-template-".esc_attr($ids)."-common-overlay .pbar-6310-template-".esc_attr($ids).":nth-child(6n+6) .pbar-6310-template-".esc_attr($ids)."-bar:before{
  border-bottom-color: ".esc_attr($cssData['pbar_progress_bar_background_six_color']).";
}
...
@-webkit-keyframes animate-positive-12{
  0%{ width: 0; }
}
@keyframes animate-positive-12{
  0%{ width: 0; }
}
