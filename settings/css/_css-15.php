...
.pbar-6310-template-".esc_attr($ids)."-bar{
  ...
  position: relative;
  -webkit-animation: animate-positive-15 ".esc_attr($cssData['animation_duration'])."s;
  animation: animate-positive-15 ".esc_attr($cssData['animation_duration'])."s;
}
...
@-webkit-keyframes animate-positive-15{
  0%{ width: 0; }
}
@keyframes animate-positive-15{
  0%{ width: 0; }
}
