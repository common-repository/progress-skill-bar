<?php
  ...
  @media screen and (max-width: 1023px) {
    .pbar-6310-noslider-".esc_attr($ids)." .pbar-6310-col-2, 
    .pbar-6310-noslider-".esc_attr($ids)." .pbar-6310-col-3, 
    .pbar-6310-noslider-".esc_attr($ids)." .pbar-6310-col-4, 
    .pbar-6310-noslider-".esc_attr($ids)." .pbar-6310-col-5, 
    .pbar-6310-noslider-".esc_attr($ids)." .pbar-6310-col-6{
