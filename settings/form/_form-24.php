<div class="pbar_6310_tabs_panel_settings">
  <form method="post">
    ...
    <div class="pbar-6310-tab-content">
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              ...
              <tr  class="skill_act_field">
               <td>
                  <b>Progress Label Gradient Color 1</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
               </td>
               <td>
                  <input type="text" name="pbar_progress_bar_label_color" id="pbar_progress_bar_label_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_bar_label_color']) ?>">
               </td>
            </tr>
            <tr  class="skill_act_field">
               <td>
                  <b>Progress Label Gradient Color 2</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
               </td>
               <td>
                  <input type="text" name="pbar_progress_bar_label_two_color" id="pbar_progress_bar_label_two_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_bar_label_two_color']) ?>">
               </td>
            </tr>  
            </table>
          </div>
      ...
      <br class="pbar-6310-clear" />
      <hr />
      <input type="submit" name="update_style_change" value="Save" class="pbar-6310-btn-primary pbar-6310-pull-right"  />
      <br class="pbar-6310-clear" />
    </div>
  </form>
</div>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.pbar_6310_value_font_color_id').hide();});";
wp_register_script( "sbs-6310-template-percentage-font-color-hide", "" );
wp_enqueue_script( "sbs-6310-template-percentage-font-color-hide" );
wp_add_inline_script( "sbs-6310-template-percentage-font-color-hide", $jsCode );
?>