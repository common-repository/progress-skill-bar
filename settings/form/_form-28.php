          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              ...
              <tr class="skill_act_field">
                <td>
                  <b>background Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
                  <input type="text" name="pbar_progress_bar_background2_color" id="pbar_progress_bar_background2_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_bar_background2_color']) ?>">
                </td>
              </tr>
              <tr>
