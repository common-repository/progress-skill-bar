        ...
        <div class="row">
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              ...
              <tr>
                <td><b>Title Height</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input name="pbar_6310_title_height" id="pbar_6310_title_height" type="number" value="<?php echo esc_attr($cssData['pbar_6310_title_height']) ?>" class="pbar-6310-form-input" />
                </td>
              </tr>
