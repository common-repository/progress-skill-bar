        ...
        <div class="row pbar_6310_padding_15_px">
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              ...
              <tr>
                <td><b>Circle Border Size</b></td>
                <td>
                  <input type="number" min="0" name="pbar_6310_circle_border_size" value="<?php echo  esc_attr($cssData['pbar_6310_circle_border_size']) ?>" class="pbar-6310-form-input" id="pbar_6310_circle_border_size" />
                </td>
              </tr>
            </table>
          </div>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.pbar_alternate_color, .pbar_animation').remove();});";
