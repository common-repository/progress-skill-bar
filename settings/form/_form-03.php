    ...
    <div class="pbar-6310-tab-content">
      <div id="tab-1">
        <div class="row pbar_6310_padding_15_px">
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">           
            <?php include pbar_6310_plugin_url . 'settings/form/_progress_bar_alternet_color_form_for_one.php'; ?>
            </table>
          </div>
        </div>
      </div>
      ...
      <div class="pbar-6310-col-50">
        ...
        <tr class="skill_act_field">
          <td>
            <b>Percentage background Color</b>
          </td>
          <td>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.pbar-title-top, .pbar-title-bottom, pbar-title-line-height').hide();});";
