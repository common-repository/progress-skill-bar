    ...
    <div class="pbar-6310-tab-content">
      ...
      <div class="pbar-6310-col-50">
        ...
        <tr>
          ...
          <td>
            <input type="number" min="0" name="pbar_progress_tooltip_background_size" value="<?php echo esc_attr($cssData['pbar_progress_tooltip_background_size']) ?>" class="pbar-6310-form-input" step="1" max="6" id="pbar_progress_tooltip_background_size" />
          </td>
      </tr>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.progress_bar_color_hide').remove();});";
