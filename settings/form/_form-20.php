      ...
      <div id="tab-1">
        <div class="row pbar_6310_padding_15_px">
          ...
          <div class="pbar-6310-col-50">
            ...
            <tr>
              <td>
                <b>After Effect Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
              </td>
              <td>
                  <input type="text" name="pbar_progress_bar_after_effect_color" id="pbar_progress_bar_after_effect_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_bar_after_effect_color']) ?>">
               </td>
            </tr>
            </table>
          </div>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('#tab4, .title_text_align_hide').hide();});";
