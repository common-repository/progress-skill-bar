  ...
  <form method="post">
    ...
    <div class="pbar-6310-tab-content">
      ...
      <div class="pbar-6310-col-50">
        ...
        <tr class="skill_act_field">
          <td>
            <b>Parcentage Icon Size</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
          </td>
          <td>
            <input type="number" min="0" name="pbar_progress_bar_parcentage_icon_size" value="<?php echo esc_attr($cssData['pbar_progress_bar_parcentage_icon_size']) ?>" class="pbar-6310-form-input" step="1" id="pbar_progress_bar_parcentage_icon_size" />
          </td>
        </tr>
        <tr class="skill_act_field">
          <td>
            <b>Percentage Icon Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
          </td>
          <td>
            <input type="text" name="pbar_progress_tooltip_icon_color" id="pbar_progress_tooltip_icon_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_tooltip_icon_color']) ?>">
          </td>
        </tr>
        </table>
      </div>
