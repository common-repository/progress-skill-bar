    ...
    <div class="pbar-6310-tab-content">
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              ...
              <tr class="skill_act_field">
                <td>
                  <b>Progress Bar Circle Border Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
              ...
              <tr class="skill_act_field">
                <td>
                  <b>Progress Bar Circle Inner Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                </td>
                <td>
          ...
          <div class="pbar-6310-col-50">
            <table class="table table-responsive pbar_6310_admin_table">
              <tr class="pbar_bar_act_field">
                <td><b>Title Background Color</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
                  <input type="text" name="pbar_progress_title_background_color" id="pbar_progress_title_background_color" class="pbar-form-input pbar_6310_color_picker" data-format="rgb" value="<?php echo esc_attr($cssData['pbar_progress_title_background_color']) ?>">
                </td>
              </tr>
      ...
      <div class="pbar-6310-col-50">
        ...
        <tr  class="value_act_field pbar_6310_value_font_hover_color_id">
          ...
          <tr>
            <td>
              <b>Percentage background Size</b> <span class="pbar-6310-pro">(Pro) <div class="pbar-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
            </td>
            <td>
              <input type="number" min="0" name="pbar_progress_tooltip_background_size" value="<?php echo esc_attr($cssData['pbar_progress_tooltip_background_size']) ?>" class="pbar-6310-form-input" step="1" id="pbar_progress_tooltip_background_size" />
            </td>
          </tr>
          <tr class="skill_act_field">
            <td>
...
<?php
$jsCode = "jQuery(document).ready(function(){jQuery('.title_text_align_hide').hide();});";
wp_register_script( "sbs-6310-template-title-text-align-hide", "" );
wp_enqueue_script( "sbs-6310-template-title-text-align-hide" );
wp_add_inline_script( "sbs-6310-template-title-text-align-hide", $jsCode );
?>