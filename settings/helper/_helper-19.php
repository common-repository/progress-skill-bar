  ...
  jQuery(`
      ...
      `).on('change', function() {
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-bar {
          border: \${pbar_progress_bar_border_size}px solid !important;
          border-color: \${pbar_progress_bar_border_color} !important;
          border-radius: \${pbar_6310_bar_radius}px !important;
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-bar:after{
          ...
          outline: 2px solid \${pbar_progress_bar_color} !important;
          ...
          right: -\${pbar_progress_bar_border_size}px !important;;
      }</style>`).appendTo('.pbar-6310-preview');
