...
jQuery(document).ready(function() {
  ...
  jQuery(`
        ...
        #pbar_6310_percentage_background_border_size,
        #pbar_6310_bar_percent_border_radius
      `).on('change', function() {
        ...
        var pbar_6310_percentage_background_border_size = parseInt (jQuery('#pbar_6310_percentage_background_border_size').val());
        var pbar_6310_bar_percent_border_radius = parseInt (jQuery('#pbar_6310_bar_percent_border_radius').val());

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-wrapper:before{border: \${pbar_progress_bar_border_size}px solid \${pbar_progress_bar_border_color} !important; 
        }</style>`).appendTo('.pbar-6310-preview');

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-value{
          width: calc(\${pbar_6310_bar_height}px + 50px) !important;
          height: calc(\${pbar_6310_bar_height}px * 2) !important;
          border: \${pbar_6310_percentage_background_border_size}px solid \${pbar_progress_bar_border_color} !important;
          border-radius: \${pbar_6310_bar_percent_border_radius}px !important;
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-wrapper:after{
          border: \${pbar_progress_bar_border_size}px solid \${pbar_progress_bar_background_color} !important;
        }</style>`).appendTo('.pbar-6310-preview');
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-wrapper:before,
