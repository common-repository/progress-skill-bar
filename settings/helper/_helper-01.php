...
jQuery(document).ready(function() {
  ...
  jQuery(`
      ...
      `).on('change', function() {
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-outer {
          border-radius: \${pbar_6310_bar_radius}px !important;
        }</style>`).appendTo('.pbar-6310-preview');
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-value {
          ...
          right: \${pbar_progress_bar_border_size + 20}px !important; 

        }</style>`).appendTo('.pbar-6310-preview');      

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-bar-striped, .pbar-6310-template-".esc_attr($ids)."-bar {
        background-image: -webkit-linear-gradient(
        45deg,\${pbar_progress_bar_alternate_color} 25%,transparent 25%,transparent 50%,\${pbar_progress_bar_alternate_color} 50%,\${pbar_progress_bar_alternate_color} 75%,transparent 75%,transparent);
