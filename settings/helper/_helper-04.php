...
jQuery(document).ready(function() {
  ...
  jQuery(`
      ...
      `).on('change', function() {
        ...
        var pbar_6310_circle_border_size = parseInt(jQuery('#pbar_6310_circle_border_size').val());
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-wrapper{
          background-color: \${pbar_progress_bar_background_color} !important;
          height: \${pbar_6310_bar_height}px !important;
          border-radius: \${pbar_6310_bar_radius}px !important;
        }</style>`).appendTo('.pbar-6310-preview');

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-icon{
          color: \${pbar_6310_value_font_color} !important;
        }</style>`).appendTo('.pbar-6310-preview');

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-wrapper:hover .pbar-6310-template-".esc_attr($ids)."-icon{
        ...
        .pbar-6310-template-".esc_attr($ids)."-title-data-container{
          width: calc( \${pbar_6310_bar_height}px * 2 - (\${pbar_6310_circle_border_size}px * 2)) !important;
          height: calc( \${pbar_6310_bar_height}px * 2 - (\${pbar_6310_circle_border_size}px * 2)) !important;
          border-radius:\${pbar_6310_bar_radius}px !important;
          line-height: calc( \${pbar_6310_bar_height}px * 2 - (\${pbar_6310_circle_border_size}px * 2)) !important;
          border: \${pbar_6310_circle_border_size}px solid \${pbar_progress_bar_color} !important;
          font-size: \${pbar_6310_value_font_size}px !important;
          font-weight: \${pbar_6310_value_font_weight} !important;
          color: \${pbar_6310_value_font_color} !important;
          top: calc(-\${pbar_6310_bar_height}px / 2 + \${pbar_6310_circle_border_size}px) !important;           
        }</style>`).appendTo('.pbar-6310-preview');
