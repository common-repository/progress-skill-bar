...
jQuery(document).ready(function() {
  ...
  jQuery(`
        ...
        #pbar_progress_bar_circle_border_size,
      ...
      `).on('change', function() {
        ...
        var pbar_progress_bar_circle_border_size = parseInt(jQuery('#pbar_progress_bar_circle_border_size').val());
        ...
        jQuery(`<style type='text/css'>  .pbar-6310-template-".esc_attr($ids)."-bar:after{
          width: \${pbar_6310_bar_height}px !important;
          height: \${pbar_6310_bar_height}px !important;
          background: \${pbar_progress_bar_circle_inner_color} !important;
          border: \${pbar_progress_bar_circle_border_size}px solid \${pbar_progress_bar_circle_border_color} !important;
          bottom: -\${pbar_progress_bar_circle_border_size}px !important;
        }</style>`).appendTo('.pbar-6310-preview');
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-bar:before {
          border-radius: 0 0 \${pbar_6310_bar_radius}px \${pbar_6310_bar_radius}px  !important;
        }</style>`).appendTo('.pbar-6310-preview');
