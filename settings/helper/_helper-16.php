...
jQuery(document).ready(function() {
  ...
  jQuery(`
      ...
      `).on('change', function() {
        ...
        var pbar_6310_bar_height2 = Math.round(pbar_6310_bar_height / 2);
        ...
        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-bar:before{
          border-bottom: \${pbar_6310_bar_height}px solid \${pbar_progress_bar_color} !important;
          border-left: \${pbar_6310_bar_height}px solid \${pbar_progress_bar_color} !important;
          border-right: \${pbar_6310_bar_height}px solid \${pbar_progress_bar_background_color} !important;
          bottom: -\${pbar_6310_bar_height}px !important;
        }</style>`).appendTo('.pbar-6310-preview');

        jQuery(`<style type='text/css'>.pbar-6310-template-".esc_attr($ids)."-value{
          top: calc(\${pbar_6310_bar_height2}px - 10px) !important;
        }</style>`).appendTo('.pbar-6310-preview');
