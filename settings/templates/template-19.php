...
?>
   <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>">
      <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>-title">
         <?php echo pbar_6310_replace(esc_attr($value->name)) ?> - 
         <?php pbar_6310_value_percentage($value, $cssData, $dynamicId, $ids) ?>
      </div>
      <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>-wrapper">
         <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>-bar pbar-6310-template-<?php echo esc_attr($ids) ?>-item pbar-6310-<?php echo esc_attr($dynamicId)  ?>" id="pbar-6310-<?php echo esc_attr($dynamicId) ?>"></div>
      </div>
   </div>
<?php
   $dynamicCSS = "
