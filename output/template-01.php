   ...
   foreach ($results as $value) {
      ...
      <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>">
         ...
         <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>-wrapper">
            <div class="pbar-6310-template-<?php echo esc_attr($ids) ?>-bar pbar-6310-template-<?php echo esc_attr($ids) ?>-item pbar-6310-template-<?php echo esc_attr($ids) ?>-item pbar-6310-template-<?php echo esc_attr($ids) ?>-bar-striped pbar-6310-<?php echo esc_attr($dynamicId)  ?>" id="pbar-6310-<?php echo esc_attr($dynamicId)  ?>"></div>
